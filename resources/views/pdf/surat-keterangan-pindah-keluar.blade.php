@php
function formatContactPindah($raw) {
    if (!$raw) return '';
...
<body>
    ...
    <tr>
      ...
      <td class="kop-center">
        ...
        <div class="kop-line-xs">
          ...
          Telp. {{ formatContactPindah($config->contact ?? '') }}
  ...
  <table class="data-table">
    ...
    <tr>
      <td>Asal</td><td>:</td><td>{{ $letter->alamat_asal ?? '—' }}</td>
    </tr>
    <tr>
      <td>Pindah Ke</td><td>:</td><td>{{ $letter->alamat_tujuan ?? '—' }}</td>
    </tr>
    <tr>
      <td>Alasan Pindah</td><td>:</td><td>{{ $letter->alasan_pindah ?? '—' }}</td>
    </tr>
    <tr>
      <td>Pengikut Sejumlah</td><td>:</td>
      <td>{{ !empty($letter->jumlah_pengikut) ? $letter->jumlah_pengikut : '- (tidak ada)' }}</td>
    </tr>
  </table>

...
const BlockView = reactive<BlockView>({
  PREVIEW: 0,
  CODE: 1,
});
...
<template>
  <div class="mb-16 overflow-hidden">
    <div
      class="flex flex-col lg:flex-row justify-between py-4 gap-4 lg:gap-2 px-0!"
    >
      ...
      <div class="flex items-center gap-2">
        ...
        <!-- Separator -->
        <div
          class="h-6 w-px bg-surface-200 dark:bg-surface-700 hidden lg:block"
        ></div>

        <!-- Animated Copy Button -->
        <div
          class="flex items-center gap-2 grow lg:grow-0 justify-end lg:justify-start"
        >
          <button
    ...
    <div
      class="p-0 border border-surface-200 dark:border-surface-700 rounded-xl overflow-hidden"
    >
      <div

...
const ahliWaris = computed(() => {
  return (data.value.ahli_waris ?? []) as Array<{
    nama?: string;
    alamat?: string;
    nik?: string;
  }>;
  ...
  <div class="preview-wrapper">
    <div class="surat-scaler">
      <div class="surat-page">
        ...
        <div v-if="ahliWaris.length" class="ahli-waris-section">
          ...
          <table class="ahli-waris-table">
            ...
            <tbody>
              <tr v-for="(item, index) in ahliWaris" :key="index">

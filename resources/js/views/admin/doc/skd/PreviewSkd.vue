  ...
  <div class="preview-wrapper">
    <div class="surat-scaler">
      <div class="surat-page">
        ...
        <table class="perihal-table">
          <tbody>
            ...
            <tr>
              <td>Warganegara</td>
              <td>:</td>
              <td>{{ data.warganegara || "Indonesia" }}</td>
            </tr>
            <tr>
        ...
        <div class="surat-isi">
          <p>
            Adalah benar warga kami dan berdomisili di RT.{{
              data.rt || "—"
            }}
            RW.{{ data.rw || "—" }}, Kelurahan {{ data.kelurahan || "—" }},
            Kecamatan {{ data.kecamatan || "—" }}, Kota
            {{ config?.city ?? "" }}. Surat keterangan ini dibuat untuk
            keperluan <b>{{ data.keperluan || "[keperluan]" }}</b
            >.
          </p>
          <p class="penutup">
